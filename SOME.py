...
\033[1;32m[-] AUTHOR    :\033[1;32m MD:HR
\033[1;32m[-] GITHUB    :\033[1;32m 
\033[1;32m[-] FACEBOOK  :\033[1;32m MD:HR
...
if 'MEHEDI'==user and 'mrx'==pas:
	...
	os.system('xdg-open https://facebook.com/groups/756797796189515/')
else:
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥HR🔥 "+w+tim)
